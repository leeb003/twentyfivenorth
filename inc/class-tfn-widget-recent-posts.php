...
/**
 * Class used to implement Twentyfivenorth Recent Posts widget.
 *
 * @since 2.8.0
 *
 * @see WP_Widget
 */
class TFN_Widget_Recent_Posts extends WP_Widget {
		...
		<?php while ( $r->have_posts() ) : $r->the_post(); ?>
			<div class="recent_entry">
				<div class="recent_thumb">
					<img src="<?php echo wp_get_attachment_url(get_post_thumbnail_id(), 'thumbnail'); ?>" alt="" />
				</div>
				<div class="sb-title">
					<p><a href="<?php the_permalink(); ?>"><?php get_the_title() ? the_title() : the_ID(); ?></a></p>
					<div class="sb-auth">
						<i class="icon-user"></i> <?php echo get_the_author(); ?>
					</div>
					<div class="sb-smdate">
						<i class="icon-calendar-full"></i> <?php echo esc_html(get_the_date('F Y')); ?>
					</div>
				</div>
