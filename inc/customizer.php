...
twentyfivenorth_Kirki::add_field( 'twentyfivenorth_theme', array(
    ...
    'label'     => __('Contact Form', 'twenty-five-north'),
    'priority'  => 17,
    'default'   => '[contact-form-7 title="25North Contact Form"]',
    'description'=> __('Set the Shortcode for the Contact Form you want to use.', 'twenty-five-north'),
    'help'      => __('We include Contact Form 7 and style it but you can use other contact forms as well', 'twenty-five-north'),
    'section'   => 'configure_sections',
    'sanitize_callback' => 'wp_kses_post',
    'active_callback'   => array(  // Kirki field dependency
        array(
